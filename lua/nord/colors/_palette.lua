...
local ret = {
  ...
  light_gray_suprtbright = "#687898", -- out of palette
  ...
  light_green = "#515E4D",            -- out of plate, used for diff view bg
  light_red = "#463B45",              -- out of plate, used for diff view bg
  light_orange = "#434C5E",           -- out of plate, used for diff view bg
  none = "NONE",
}
