...
function M.get(c)
  ...
  return {
    ...
    ["@neorg.headings.1.title.norg"]        = { link = "markdownH1" },
    ["@neorg.headings.1.prefix.norg"]       = { link = "markdownH1" },

    ["@neorg.headings.2.title"]        = { link = "markdownH2" },
    ["@neorg.headings.2.title.norg"]        = { link = "markdownH2" },
    ["@neorg.headings.2.prefix.norg"]       = { link = "markdownH2" },

    ["@neorg.headings.3.title"]        = { link = "markdownH3" },
    ["@neorg.headings.3.title.norg"]        = { link = "markdownH3" },
    ["@neorg.headings.3.prefix.norg"]       = { link = "markdownH3" },

    ["@neorg.headings.4.title"]        = { link = "markdownH4" },
    ["@neorg.headings.4.title.norg"]        = { link = "markdownH4" },
    ["@neorg.headings.4.prefix.norg"]       = { link = "markdownH4" },

    ["@neorg.headings.5.title"]        = { link = "markdownH5" },
    ["@neorg.headings.5.title.norg"]        = { link = "markdownH5" },
    ["@neorg.headings.5.prefix.norg"]       = { link = "markdownH5" },

    ["@neorg.headings.6.title"]        = { link = "markdownH6" },
    ["@neorg.headings.6.title.norg"]        = { link = "markdownH6" },
    ["@neorg.headings.6.prefix.norg"]       = { link = "markdownH6" },
